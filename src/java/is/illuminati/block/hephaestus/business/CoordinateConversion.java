...
public class CoordinateConversion {
	...
	public static void main(String args[]) {
		...
		double[] latlong = conv.utm2LatLon(263340.2d, 4363039.5d, "11", "P");
		System.out.println("lat = " + latlong[0]);
		System.out.println("long = " + latlong[1]);
	}
	
	public double[] utm2LatLon(double x, double y, String zone, String latZone) {
		if (zone == null || zone.equals("")) {
			zone = "11";
		}
		
		if (latZone == null || latZone.equals("")) {
			latZone = "P";
		}
		
		StringBuilder utm = new StringBuilder(zone);
		utm.append(" ");
		utm.append(latZone);
		utm.append(" ");
		utm.append(x);
		...
		return utm2LatLon(utm.toString());
	}
